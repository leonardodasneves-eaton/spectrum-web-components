...
**Note:** Version bump only for package @uxds-web-components/overlay
...
-   **overlay:** allow "receives-focus" to target the root of an overlay ([#3658](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/3658)) ([0db1025](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/0db10258d84409d364b5e1bad57e71683de93fea))
...
-   **overlay:** init tab trapping on OverlayStack construction ([a3121e3](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/a3121e38df47fb528f8366cdb68e83417d78dc95))
...
-   **overlay:** removes use of px units in overlay stack ([122f96c](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/122f96c06ac2b5349acff0497fed1697264958f8))
-   **overlay:** reset cached values and applied CSS before "updating" overlays ([b871e52](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/b871e52950aaa3b1d7990d77e26b8285040ecb6e))
-   **overlay:** resolve async races with closeOverlays and manageOpen ([ff3738e](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/ff3738ea7afc12f258a7745777034ee70d6bf601))
-   **overlay:** stop the tab trapping if shadow root is not found ([4f0ec46](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/4f0ec464bcc807e3a789bb5fd323b468d978e4a2))
-   **overlay:** support positioning overlays within parents leveraging container-type rules ([21044b3](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/21044b3c8b5bed0af02f836b6ee6796554a90325))
-   **overlay:** surface "overlay" property to "sp-opened" and "sp-closed" events ([957f8e9](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/957f8e9b42f5ad4672fe128fc42693d0065bb2d5))
-   **overlay:** track "modalRoots" for expanded overlay management ([dceccb1](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/dceccb1617d54da4c0db8035954a4eb4e0367c30))
-   **overlay:** traverse up through shadow roots when determining parent overlay ([27f232c](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/27f232c28d30288b75187b80744b2581d6017b77))
-   **overlay:** use esm build from popper and point through to types ([078ca0f](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/078ca0fb9bc43d1ee5288e641ff1ec49f40e8df5))
-   **overlay:** use isolatedModules in tsconfig ([48d6069](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/48d60694ad5d6014b8664f515e698651f55c9e5f))
-   **overlay:** use tabindex=-1 but always remove it on open ([6047003](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/6047003eca58232f90a0c6b2ab0e5bd9fb678eb7))
-   **overlay:** vend a VirtualTrigger for overlays with no element trigger ([a359c60](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/a359c6078aa4fac3c9a7bd140609acd4d9aed81d))
-   **picker:** add loading state to the picker ([#3110](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/3110)) ([d91e2c9](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/d91e2c9f3530c3c911832ea3a401fddc23e7854a))
-   **picker:** use "modal" as the menu overlay interaction ([c8fbbe2](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/c8fbbe27b19702909855575b1afd38fb064e8378))
-   prevent "hover" overlays from receiving focus ([7bd5ac2](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/7bd5ac26589f4248bdcde1ee3a168052b5a7bf20))
-   prevent "hover" overlays from returning focus to the root of a parent modal ([ceb8fa7](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/ceb8fa73d23f6c9ccb6f2a00c18708d496975473))
-   prevent leaving multiple submenus open at a time ([d2bfbb2](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/d2bfbb2d8334ae1a6bd21381092d54914b8f708c))
-   prevent longpress when interacting with context menu ([f8b0732](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/f8b07321741ee44515fced9923167b96561cdd48))
-   prevent touch scolling on non-modal content ([e471feb](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/e471febf14e64d35b57ebc0c1596c52282a6ff2a))
...
-   special case the possibility of leaving an overlay trigger by entering its overlay content ([c32a075](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/c32a075e0e80d89e9c71dea4a9529971691c1098))
...
-   support generating random IDs outside of secure contexts ([485a67c](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/485a67c5401094705b711350f8ee74182a6dd64b))
-   **theme:** track default theme values dynamically ([a0c306c](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/a0c306c9682d97cefa1258e01ce6eee179f0e071))
-   **tooltip:** correct arrow orientation, remove popper-arrow-rotate ([fcd6ea2](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/fcd6ea28ef5e4f06a07994ebd8f8b9be1a934eb2))
-   update "reparentChildren" types for flexibility ([2d358be](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/2d358be094cf73785d0858545ccd0f9ca2aa8db0))
-   update presence confirmation so popper is available on update ([24f8380](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/24f83800a2011f9181947795d9249b87be99f8ab))
-   update screen reader interface with menu items list ([16756b5](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/16756b56c0f7f9561426acc202997fb098e8f19a))
-   update when events are added to manage overlays ([60cddac](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/60cddac69554d00095aee492608d85d6513c8928))
-   use "fixed" strategy to prevent unexpected overlay placement ([e39e108](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/e39e108def1336adabb21823d1454e917fd38599))
-   use height: 100% to avoid layout breaks ([1498129](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/14981291e6d860a8fde7e1746a4a03af4df1e572))
...
-   use less restrictive overlay sizing ([f6917aa](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/f6917aa4ca22360ba66e40fc933c0e994a04b8c9))
...
-   wait for fonts ready before positioning overlays ([cb8026a](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/cb8026a1999a4458b442673291214269fc1e1cef))

### Features

-   add open/close events for some menus and overlays ([17f0a58](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/17f0a58722fdfee39653c2abde048391f7f24564))
-   add support for Spectrum Express ([12bfe99](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/12bfe99570122514fa88ce1a4e4a1591bcc5aa70))
...
-   allow activation of longpress content ([55e71fd](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/55e71fdf9fd5dde489871c3d9798ef8957f4e5b6))
...
-   **dropdown:** open menu UI with overlay system ([9811eeb](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/9811eebc33d892da46752981f5bfa49c42ab1192))
...
-   join overlay-root and overlay-trigger as overlay ([dcde42c](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/dcde42c118b76bf8466c7475611e95783a1dcb3d))
...
-   **overlay:** manage focus throwing and tab trapping ([27a0b53](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/27a0b53ea94d19bb18b7d3f89763b06dc1b42b59))
-   **overlay:** move entire package behind dynamic import by default ([9b0a74d](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/9b0a74de1f32ccd8cde6cabe4c06f990064f11ae))
-   **overlay:** ship Overlay API v2 ([67b5d1b](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/67b5d1b02e88dcb5b0b79b5a6c5ead92ad1a5aca))
...
-   **picker:** support responsive delivery of menu ([20031d1](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/20031d1b42b36cdaa129a25ee70eb2bcbcdbdb5e))
...
-   reparentChildren - refactored arguments - breaking change ([dea2bc5](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/dea2bc5cba1185e790a834db43daf8fc45f4e4f7))
-   rework overlays to use popper ([e17d1bb](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/e17d1bb23082b788ea921ec15315ea955e2596eb))
...
-   **sidenav:** add keyboard accessibility ([6ff622b](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/6ff622bf89ad319a7d464fbdd2477c7b55b65cdd))
-   **split-button:** add split-button pattern ([4833a59](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/4833a598bb3da3552d194586350a3888dba79543))
-   **story-decorator:** add story decorator to replace knobs for theme application ([7c0c6be](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/7c0c6be37d58ad3e6d8973e8d4f5ccc587bf55af))
...
-   make lots of things lazy ([b8fa3ad](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/b8fa3ada062bf54bbb42e76ab156c716d5820c7c))
-   open/close timing update ([d4ebcd3](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/d4ebcd36ed5a256f211186e6863c3eee2631fa3f))
