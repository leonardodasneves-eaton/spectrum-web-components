...
**Note:** Version bump only for package @uxds-web-components/tabs
...
-   extract and share tshirt size styles ([b1440f7](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/b1440f7e828f525a101ffba69df16984be154da1))
...
-   remove attribute binding logic ([1f6833f](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/1f6833f6f1058b7c91aec45ba51330c9dfbe6372))
-   remove attribute binding logic ([7bce0ae](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/7bce0ae239e55a6479268ab76a992199452c0cb5))
...
-   support matching keydown to [dir] ([70b40a9](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/70b40a9d3bb5fe2d12208365abf132260270721b))
-   tab indicator positioning ([8c20769](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/8c20769030c3c90620f1f2e397f5f5b83b2a49c9))
-   **tab-overflow:** improve tab navigation experience and support custom aria labels ([#4165](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/4165)) ([9c9bf95](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/9c9bf952cf2a1e4a0c5bc35e63e46f5d5bd6afe8))
-   **tabs:** account for the indicator bar in the overflow decorator ([f4a8744](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/f4a8744ed5cb38608ae856539ce7c34ca212b3d4))
-   **tabs:** add "emphasized" and correct WHCM delivery ([27940bd](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/27940bde2444040910bf772c757514fbabdee85c))
-   **tabs:** add "quiet", "compact", and "emphasized" "direction=vertical" ([26fff53](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/26fff53d8d64c508be66406d00e6e45e48c15278))
...
-   **tabs:** added test ([7d5f41f](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/7d5f41f74d2467e9d12a1a2328db1ff3dd6a8a71))
-   **tabs:** allow bi-directional arrow key navigation in both orientations ([#3410](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/3410)) ([ea10049](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/ea10049c4d9eea0ef619cdd41fae2e1152455570))
-   **tabs:** bind tabindicator update to dir value ([09598b5](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/09598b59f1198b7ebc8067834681000ceee0918e))
-   **tabs:** bind tabs overflow state with sp-tabs ([a07c45b](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/a07c45bdce27a7b0bed3faf46bd638ebab9b42d9))
-   **tabs:** bind tabs overflow state with sp-tabs ([570a2cd](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/570a2cdaf282ef0f565574c65eef619c82ef2a60))
-   **tabs:** bring selected tab into view ([#4032](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/4032)) ([a187057](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/a187057afa7ac073fe45117ebd0bc2315e6fea5e))
-   **tabs:** correct entry focus element ([64407d3](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/64407d37fd09d3d598253a66c3b342882d51a826))
...
-   **tabs:** ensure only one active tab stop in the tabs ([68b2523](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/68b2523d2287ad8bdb82d2c8b0e79b30129317c4))
-   **tabs:** ensure tabs has layout ([7aba515](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/7aba51561965342ea3e18404621659aa32c2ed8f))
-   **tabs:** ensure that "auto" attribute is respected ([d200775](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/d20077516fadeb42b8814416f87689254e4e0381))
-   **tabs:** error on click - undefined tab target ([9742227](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/974222739745e1a8c082ed77e3e68199907f7890))
-   **tabs:** include sp-tab-panel.js in the export map ([1619ae8](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/1619ae876d70d35eaff38aa955f3cd307f4a5c54))
-   **tabs:** manage disabled state on tabs and tab elements ([58def1f](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/58def1fd7a724cc078459c56f39c19ebe2005f97))
-   **tabs:** prevent vertical scrolling in overflow tabs ([eb0592f](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/eb0592f87c1f52fe34745af030331060b3641a59))
-   **tabs:** update css workarounds ([c2a17e0](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/c2a17e02ac019dc7a28411bdc2f666f8c27c26b8))
...
-   use CSS position relative and revert Tabs.ts changes ([a682bcf](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/a682bcf149bc8d7e09875838323145883dbd3cbd))
...
-   **tabs-overflow:** address comments ([b0e3398](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/b0e3398518d8c8d72dc901bd3c137a7c4c8f4b54))
-   **tabs-overflow:** first round implementation of sp-tabs-overflow ([c5b589a](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/c5b589a41d74e61edfd1a10f012f70052ae39f6d))
...
-   **tabs:** add test coverage, remove unused property from component class ([9933ad8](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/9933ad83dea315533bd749be9a25a15d9a33b24a))
-   **tabs:** add test coverage, update import paths ([d104b52](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/d104b520f1ae0892f4905b6ba4e5d41d13e2fa76))
-   **tabs:** moving tabs overflow under tabs package ([a18c692](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/a18c692a858163859cc73c86755a078ee003d67f))
-   **tabs:** update bundle setup and readme ([0249b94](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/0249b94d36567f9a1e6c9de35a56ffeb1163df1b))
-   **tabs:** update imports to get correct coverage ([2e421cd](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/2e421cda336833b55ba67f0e69bc76195e2b5a0a))
-   **tabs:** update spectrum css input ([d875a0c](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/d875a0cdeba6e798ff129409b2b809d9d8adaae3))
-   update card and tabs to latest spectrum-css ([55b8d67](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/55b8d67c03349183c3aebb52bbc54f5c58b3fdb4))
