...
**Note:** Version bump only for package @uxds-web-components/button
...
-   added role for href button ([5a4ad98](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/5a4ad98afa69669a8a4fb2a88d82a837c0c40c55))
...
-   **button:** revert default "variant" application when missing ([fab993e](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/fab993e72dad8d7c4962e6d00632803c1a4d30ef))
...
-   **progress-circle:** ensure size can be applied to non-"size" attribute bearing elements ([2bc1065](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/2bc10652ff9d7337c15eb8b3704678d0f2c700c9))
-   remove errant readme content, correct icon selector ([3dd1fb1](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/3dd1fb1ebd5ce5171345a6c2d4aac08e2d49a5b8))
...
-   **shared:** make Focusable pass disabled always ([a339d6f](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/a339d6fb2aa9645e7bca5472487618edff5f1182))
...
-   text fixes ([0121fd6](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/0121fd6e25755881f5f00c8b7cd989fc47e201d8))
...
-   update role application logic to not overwrite menu\* roles ([94b6aec](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/94b6aecffc1e5686feab09361d4e07ec3e854726))
...
-   updating spectrum-config to support new label styles ([cefeaad](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/cefeaade098d246f7b222e54de5ff8becf42d315))
...
-   work around icon positioning error in CSS source ([ef5271c](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/ef5271c208569b44166b00692baa2caeb0a30d27))
...
-   **action-group:** add action-group pattern ([d2de766](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/d2de766efde6dfbaa1cd604f99ae3128b4fc81b5))
-   **action-group:** manage "one" and "multiple" selections ([6fad59e](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/6fad59e0df1210108fe6b54ab075c0cbd94cae78))
...
-   **button-group:** add ButtonGroup pattern ([c4d85b5](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/c4d85b5524f6623dbd3cb22c0d6fa8fc00e98733))
-   **button:** accept update Spectrum Tokens ([d6d6db1](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/d6d6db152ea9a1bf1ca7a475ce847ff3ca471037))
-   **button:** action-buttons with icons AND text ([aa788b1](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/aa788b106b6d649841f54a61de61e131293a244a))
-   **button:** add support for "sp-clear-button" ([9028b6d](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/9028b6da78b461d6972ea38a5df28dcdb38f20f6))
-   **button:** allow icon only buttons ([25623d6](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/25623d686663388ef1fe427e99c9040359516fa7))
-   **button:** move "white" and "black" out of "variant" and into "static" ([5cf51df](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/5cf51df7db6f010f4c22d125b17a68e54fd507ba))
-   **button:** pass "label" property to "aria-label" ([78ae59d](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/78ae59d260c7e2c0aec16841d96c0c3177061bab))
-   **button:** update spectrum css input ([7b5b200](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/7b5b20012621a4a43c8402fb07fe163fe919495d))
-   **button:** use latest @spectrum-css/button beta ([b3b20ed](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/b3b20ed85923955deca5ca4d18d95ea8c5ce15ea))
-   **button:** use synthetic button instead of native ([49e94bc](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/49e94bcf79da6ec1ef05f4197042f992922b91ca))
-   **button:** using core-tokens for button ([a4a6d42](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/a4a6d42e7615466c6de344ccf36c8d7b4903a921))
-   **card:** upgrade to Spectrum CSS v3.0.0 ([84cf1a9](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/84cf1a9758b1e357f18efac5763d17d6a4db0578))
...
-   deprecate "icon-right" in buttons as per Spectrum ([064a775](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/064a775f9915523a3c9a744f824b5903f26c382e))
...
-   **search:** adds sp-search element ([d484fc2](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/d484fc2848a08d52ebb1fc2064202a4288b6b4b3))
...
-   support Spectrum Token consumption and update Action Button to use them ([743ab16](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/743ab16d8f05335d320440effbdcb8cd4bffc97d))
-   support static white and static black variants of Action Button ([7f1e25b](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/7f1e25bce122bd3601c6aa5ed505cba436e8b952))
...
-   accept new Spectrum CSS featuring simpler DOM structure ([a0b042b](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/a0b042b1d05bc23b0b824123af94df5bc3e1e0d2))
-   **button:** recentralize shared styles in base ([85d3d0a](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/85d3d0a3c84301dcf5be492e2b42cd00e8986089))
