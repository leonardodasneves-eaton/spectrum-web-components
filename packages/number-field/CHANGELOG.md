...
**Note:** Version bump only for package @uxds-web-components/number-field
...
-   **number-field:** added flag to scroll event to allow slider component to update on scroll ([4199eb0](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/4199eb0084dcaa9da77f3ff3880dd93f24f72b1d))
...
-   **theme:** stop language resolution propagation and demo using local languages ([6b81391](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/6b81391c3e4416889daa5627526dc0194f2f5f56))
...
-   **number-field:** add number field pattern ([384ab34](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/384ab34d5aafe54e3206ff6802eb642c4df556c6))
-   **number-field:** use core tokens ([23a924e](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/23a924ef24ea5adfa0472e8e424bfeec1d184603))
-   **number-field:** use new config ([8d42d69](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/8d42d693363e69362e18c49f1d7a5c91262f4c38))
