...
**Note:** Version bump only for package @uxds-web-components/picker
...
-   **picker,action-menu,split-button:** update interaction model ([#3935](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/3935)) ([bae7d52](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/bae7d527e513d2588267c62cc70f5e1c1289f903))
-   **picker,split-button:** include "tooltip" slot in the main button ([699b8af](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/699b8af2612f2dab8f7c65b9c105844f6feaa6ed))
-   **picker:** accept new "value" and new option post first render ([8f8c93f](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/8f8c93f1045b07d5e108769c4efffa54213d20e3))
-   **picker:** add "quick select" action to right/left arrow keys ([21895ee](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/21895eed8d194b0a570cbb2bafeaa06c9511bf27))
...
-   **picker:** allow menu items to be added, updated, and removed ([73511ba](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/73511ba996154c006602dfd1c7f1d94746049782))
-   **picker:** allow open/close in tablet ([dcfc96e](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/dcfc96e779c0dd6005f4697450d1edcf7809e8ea))
-   **picker:** correct attribute spelling of "aria-label" in dismiss button ([5fc9b30](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/5fc9b30260f7d6df4d6e3cb6a3e49a149ece5458))
-   **picker:** correct implementation of "disabled", expand stories and documentation ([#4040](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/4040)) ([84c2fef](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/84c2fef72cb8be6d77ce62c21ed6d9d0d866d849))
...
-   **picker:** correctly process the CSS for the quiet hover effect ([#4167](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/4167)) ([eb282fa](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/eb282fad1d1b4f5e7c2bce65df6ca56f46e6870e))
-   **picker:** ensure focus visibility application ([2679081](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/2679081978788bd68b5e2c9cd1c05161cc571446))
-   **picker:** ensure menu placement in mobile ([#3835](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/3835)) ([4aba1c6](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/4aba1c6094e45481dec428fcc95fb4148f62dbc9))
-   **picker:** ensure that width is customizable from the outside ([702b052](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/702b052f9ea1686d2a964648d4bb1d365178160f))
-   **picker:** ensure the Menu opens in a Tray on mobile ([6be2bed](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/6be2bed36b364c5abcd1210db9c95ebc883125ec))
-   **picker:** force close slotted Tooltip elements with disabled when Menu openes ([82c8f12](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/82c8f129d8a378f51ca083c4020a15b3cbde1fe7))
-   **picker:** make "change" event bubbling and composed ([1fdd33d](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/1fdd33de0f8a01640b91ecda2cb9e81bd8076adf))
-   **picker:** prevent the Menu opening until required dependencies are loaded ([55e6174](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/55e617497477f2627982f877743f1635e32ee583))
-   **picker:** query less strictly to support automatically selecting values ([969f966](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/969f966585256c3a496eddb4cb84c0142aa7ae9c))
...
-   prevent console.log in source and test files ([3ee082c](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/3ee082ceadd9eeef167bb8ac6241fe1501e4426c))
...
-   simplify focus application in Menu ([6140169](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/61401699b36298b6f11cc80703aff664cbb867a7))
-   simplify optionsMenu usage and fix tests ([91241b7](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/91241b7bddc434c7220fc0fbd65389d0ca38f674))
-   slot documentation ([0ebd260](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/0ebd2609bad9e95ee24428cb2fa666d23bdb85f8))
-   split-button tests & lots of cleanup based on review feedback ([10b4a04](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/10b4a04c5791d1acd9e59d48a8960b9c17aa89c7)), closes [#1189](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/1189)
-   style icons in Picker correctly ([0bbdf84](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/0bbdf84df595a573b355721698262b1c5a1f3b01))
-   support a wider number of sizes ([ee44978](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/ee4497830da0d3bc63d4414ad5548291a39588c7))
-   update Picker label via MutationObserver instead of "slotchange" ([196998e](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/196998e9433dc938d86bfbe77db9e3accd6d9bbc))
...
-   add selects attribute to menu ([bdf2578](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/bdf25780e56c7b92368904dce2a02f2594c364a2))
-   add t-shirt sizing with visual regressions to checkbox and picker elements ([ce47ec8](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/ce47ec88bd2c6c8d236c05826d28b2d0dadf12b8))
...
-   conditionally load focus-visible polyfill ([6b5e5cf](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/6b5e5cf515f02ef14f072b7aee62feed7a83c281))
...
-   deprecate sp-menu in PickerBase derived classes ([bbb773c](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/bbb773c915587b9d92875e333a6b422ec878a8ea))
...
-   **menu:** convert to core tokens ([#3254](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/3254)) ([da43540](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/da43540abcea3db75bf145194be800b61153ebe0))
-   **picker,action-group,split-button:** leverage Overlay v2 ([170a223](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/170a223d74870ed3eda452285943716f8cbf4b7c))
...
-   **picker:** replace dropdown with picker component ([30b8bc7](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/30b8bc791be37ba53a12244f3dd2cccd55c490a3))
...
-   **picker:** update "icons-only" to "icons=only" to support more variations ([de16a62](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/de16a628f6ec7cfcbe405c71414bef6ed72b1726))
-   **picker:** use new tokens ([7d65b69](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/7d65b69d47d69a34f75b456a5aa457f22ec04aca))
...
-   make submenus lazier ([a2d661c](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/a2d661cf4095f4ccb826d17b6f2e665c8c5bf70f))
-   reorganize inheritance and composition in Menu Items ([d96ccb6](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/d96ccb621833277444d69535126c3669343c2eaf))
