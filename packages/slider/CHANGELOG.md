...
**Note:** Version bump only for package @uxds-web-components/slider
...
-   prevent active pointer events when slider toggles to [disabled] ([ceb4d74](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/ceb4d74abdbfb622e4a3cc17fc1e0b248af4df12))
-   prevent mobile interactions from triggering the virtual keyboard ([d06ad17](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/d06ad17f12b77f791c8710567ae9bf2d4b26278f))
-   prevent tabindex=-1 elements from placing focus on their host ([1ac1293](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/1ac12931771c6d5fdbc99f5d214702ed644cb81a))
...
-   resolve "updateComplete" with a boolean like LitElement ([2ebcd44](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/2ebcd449185a2a26b8ca60441793048a76bb3ed7))
-   simplify touch-action application ([d23f735](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/d23f735db3cea01c2243e0485448d1598c6a8692))
-   **slider:** [#3340](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/3340) fix visual regression ([88e0bda](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/88e0bda41df9f1ebb21debf97db05b0fd144deb7))
-   **slider:** add "fill-start" attribute/property and associated "variant="filled" visual delivery ([#3876](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/3876)) ([2c3e35e](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/2c3e35e858bbc10f162f719ada1356c516111050))
-   **slider:** add less visually effectacious style to the slider output when editable ([8702294](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/8702294fb19da70a70ddadb1e9ed1b401ccc8d91))
-   **slider:** add quiet and indeterminate ([8990573](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/8990573a4d946920b97117e87f8776c0e7214b04))
...
-   **slider:** align editable slider when no label provided ([#3816](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/3816)) ([a5f4900](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/a5f49009d4acc1e8c5403a08b127769e18bda56c))
-   **slider:** allow irregular tick spacing and correct RTL value application ([a83f879](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/a83f879bfef87b928452104a47b45201ab30ee89))
-   **slider:** allow pointer interactions that start at the very begin/end to be tracked ([ff8c95c](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/ff8c95c6a1c7be3da0bed162064302591712d275))
-   **slider:** allow slot based label content ([d2d474e](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/d2d474e9385b3445aff3ca152c70ee12ecf6b3fb))
-   **slider:** apply "handle.highlight = true" when using the keyboard to interact with handles ([94e6349](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/94e6349a7750b43c455377cb096a24072d668056))
-   **slider:** dispatch synthetic pointerdown event ([7dc74af](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/7dc74afdda380184906cceadf4eb528b6106792c))
-   **slider:** double click on slider handle to reset slider position ([#3991](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/3991)) ([64c594a](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/64c594a7c305bd4946bb5801341366a1e751a614))
-   **slider:** ensure "sp-slider:input" is dispatched appropriately ([ded5440](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/ded544078d56d4358e6767e2a68d5151787695da))
-   **slider:** ensure first render when no "value" is supplied ([eed860b](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/eed860b28321a250a9160c2b597b12cdd2aea9c0))
-   **slider:** ensure min/max/value application order ([80e8cb5](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/80e8cb54d0868ce3f4451c3451e95a89b8b5a229))
-   **slider:** ensure pointer events on the track and handle act the same ([03adb36](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/03adb367fd945c2c07cc8e6179207fc4e654fc0a))
-   **slider:** ensure that handles are upgraded before extracting a model from them ([bbbb21f](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/bbbb21faba2111480441a30224a3c26ad9858441))
-   **slider:** ensure track widths follow dynamic Spectrum CSS values ([5ad1c1a](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/5ad1c1aef32cd2988fd86a4c48f19173d6c9c0c2))
-   **slider:** ensure value is bound as a property ([96bd01a](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/96bd01aacfddfe3a51524c59d346f57e0ac346b0))
-   **slider:** ensure z-index in Express theme ([c0cc655](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/c0cc655bd834188e26850309d71fbd0fb63ee7f5))
-   **slider:** fixes usage of aria-valuetext, adds aria-valuenow ([4b25a89](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/4b25a89d6018a8929c3b777cc196354d93d0af69))
-   **slider:** high contrast improvements for filled track ([#3952](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/3952)) ([782560d](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/782560d98c3431c9f4467c4b93857133f30dc0d6))
-   **slider:** make implicit dependency on sp-slider-handle explicit ([cb8d84b](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/cb8d84b55beb968fcb92198854321d66ce01cbf4))
-   **slider:** manage focus more like a native rage input ([865115e](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/865115e1e43e164952eeca01b473c9606762377a))
-   **slider:** manage value and max changing in unison ([4359fbe](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/4359fbee9ce545064f35aee5e0c6a1dadd11ddd6))
-   **slider:** prevent pointercancel events by container touch-action ([4687d03](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/4687d03c2b1ea1de3cb76d6ed3782e56153d271f))
-   **slider:** reimplement gradient slider track application ([a10b91e](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/a10b91ed168ba58f02349e05e1c49898e8686206))
-   **slider:** renamed flag from stepperActive to managed input to allow verified (scroll) input event ([89d6ac5](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/89d6ac5a197c55ff8dae9932996fbb8c953bcfb2))
-   **slider:** response to orientation changes when measuring the bounding box ([c1412f1](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/c1412f19a5e91dd518b51277d3bbed3aff6dafac))
-   **slider:** revert handle ui at min/max values ([#4042](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/4042)) ([da13af7](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/da13af78feb313a2c0aade65f87404cfa81fac72))
-   **slider:** simplify application of the gradient backgrounds ([f96a97e](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/f96a97eafab63358de3b438d84a2af521250f4ed))
-   **slider:** slider input aria-valuetext omits formatOptions for unit [#3340](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/3340) ([d5ff7e6](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/d5ff7e6e0196580f25941caa1a304557cb0f5088))
-   **slider:** support customizing visible label delivery ([a55b585](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/a55b58517f0f20df356a523a14550d8870b7282a))
-   **slider:** support non-supported units in "Intl.numberFormat" ([ac32355](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/ac32355f3d6459937b025d2fce9f006b0226622e))
-   **slider:** update a11y tree and default max value ([3cbf222](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/3cbf222386d53cdd77847bb9093f494e542c9195))
-   **slider:** update CSS conversion for more correct visual delivery ([99c83e4](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/99c83e46d138c5bbfa43c519c38770d7fbe34ca5))
-   **slider:** update handle alignment and color application ([#3860](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/3860)) ([bed73c0](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/bed73c03827766fc9802840795df2b43be4f090a))
-   **slider:** use internal "input" for value sanitation ([dd588c9](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/dd588c93003a9e9c10da4832590403ebc9e46020))
-   **slider:** use standard "change" and "input" events ([59cf786](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/59cf7866a9b7b7368ccf01d237534a495274af32))
-   **slider:** work around Spectrum CSS bug in variant="range" styling ([e5810a9](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/e5810a9c8304f90a2d6f78ea9f1c911fb37d037f))
...
-   update consumption of Spectrum CSS for latest version ([ed2305b](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/ed2305b7334c973ea5c8299cbbce33a365896329))
...
-   update method extension types to match ([6eb686f](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/6eb686fbc7ad336ec245fbf2edd6aa769486533c))
...
-   update spelling ([283d10a](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/283d10acf09f1c3a2575d5dd263559d0c63a69fa))
...
-   use ObserveSlotText mixin to prevent white space from overriding label attribute ([610fb4b](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/610fb4b5b392b7e3673c7d46bf8f9f5f79f27ca9))
-   use the "browsers" listing in postcss-preset-env ([4eaf6a2](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/4eaf6a28f7b5eaf60487841d264d6d804ae675ce))
...
-   multi-handle slider implementation ([8d5a743](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/8d5a74309ec171107a9504695216cb90abe39023)), closes [#1385](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/1385)
-   **popover:** use core tokens ([68328cc](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/68328ccd01f44758caf987e02a17d88488f9046c))
...
-   **slider:** add "ramp" and "tick" variant support ([bb98bb6](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/bb98bb6e1e7ac7b795c29b5085e7ebef57d8ca94))
-   **slider:** adds getAriaValueText property, fixes [#381](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/381) ([5800915](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/5800915bb805022cbe4c8ea822631c11da03fc98))
-   **slider:** mouse event fallback from pointer events ([b69e7fc](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/b69e7fc23966386097e0cad22c56ab02f70abcae))
-   **slider:** support tick labels and tick steps ([1ccf8d6](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/1ccf8d6f2ac33843c6cb27e2e86f0943aab31a6d))
-   **slider:** update "value" default to match browser native range input ([0050f63](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/0050f633ad2a0d7db192af0e8a77f6b7c646a256))
-   **slider:** update spectrum css input ([21ebe36](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/21ebe36d600501771c3382e987f4e22753c36262))
-   **slider:** use latest @spectrum-css/slider beta ([9f29bbe](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/9f29bbee3a43c092f4ee141e18a96fe0dfa4fba4))
