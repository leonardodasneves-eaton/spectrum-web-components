...
**Note:** Version bump only for package @uxds-web-components/textfield
...
-   correct composition entry of multi-byte numbers ([#3610](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/3610)) ([5e11934](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/5e1193455dd876a45648b3040688a3bc389819a1))
...
-   setting title when textfield is invalid ([36d0537](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/36d05372bd829470ac3e16f52f1fad2a7ea513ba))
...
-   **textfield:** add 'u' flag to keep consistency with native input element ([0af779f](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/0af779f040ebe1b2b2a80a19afe1df42201dbe3e))
-   **textfield:** add maxlength and minlength attributes ([5326649](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/5326649daac788e922a4493b9172cc20518b8abb))
-   **textfield:** add rows attribute ([#3356](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/3356)) ([1ee1c37](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/1ee1c37f219c82fd74ca1b89941d4f59ccfd2785))
-   **textfield:** add select() API mapping to shadow DOM element ([d467a34](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/d467a3463f326d839c9d51ffacd24f8fdfb1aff1))
-   **textfield:** add support for [grows] when [multiline] ([3b306d4](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/3b306d434d366ae826ecf7d47e20f7780eb74a28))
-   **textfield:** break very long words within the Textarea's sizer element ([2f95ac0](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/2f95ac04a3ad3c200172cd3c364c9014c7d6dfde))
-   **textfield:** clearly mark/support "multiline" as a requirement of "grows" ([a3e464d](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/a3e464d7ceda90ad241641916180ab6e8ea119dc))
-   **textfield:** correct "multiline" and "grows" delivery ([fa0ac34](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/fa0ac3437b269f009ef47d080b41996fe0a25779))
-   **textfield:** leverage aria-invalid attribute ([e718c0a](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/e718c0ac0d9f037b2bb9c6fb53ffc2121298731a))
-   **textfield:** prevent IME selection misalignment in Safari when using hiragana input modality ([f8e1e70](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/f8e1e709e99d62e67589d8f54f15d49a9ecf2f32))
-   **textfield:** process ".is-focused" and ".is-keyboardFocused" styles ([48fd67d](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/48fd67d7cdab3aac26c20a8e9232d6320b27fb59))
-   **textfield:** reimplement min/maxlength ([23a4c2e](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/23a4c2e61dbc399bf9e58bb32952e16b8aa9d5ae))
-   **textfield:** remove use of sp-icons-\* ([9a5c213](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/9a5c213a886146709601a2878484529c315d9f51))
-   **textfield:** respect resize styling ([04993c3](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/04993c380d485b0e9b02fd6ad196e5caaf29e0a2))
-   **textfield:** respect type=text|url|tel|email|password ([1b7a59a](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/1b7a59a208ce00a62c23c80b75bacabf73c3e6ea))
-   **textfield:** update focus state when [multiline][quiet] ([#3452](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/3452)) ([a7f563a](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/a7f563a240cda22c58c4a850fc65ed5d867bafb1))
-   **textfield:** update for easier extensibility ([9deaf9e](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/9deaf9e4f5a476593378f8feaaae352fd8bb80d7))
-   **textfield:** update validation path, add "allowed-keys" ([ae9f85d](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/ae9f85d3b0ec30bbcf5fbe3d4750a1cd96c990d5))
-   **textfield:** Use correct filename in exports field ([637b166](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/637b166420e3a0fa41980bfbb24129df77ff4efd))
...
-   **search,textfield:** use core tokens ([2ed5135](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/2ed51355c2787ac06274e763ea1eee7bfd0c9c72))
-   **search:** use Spectrum CSS ^3.0.0 ([7830ac0](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/7830ac0868e855145cee0922529a0f6d4d3e7f50))
...
-   **textfield:** add support for setSelectionRange ([#2070](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/2070)) ([dd17ba0](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/dd17ba0f50cc604b4dcd14699d5129710aac121b))
-   **textfield:** added name attribute to textfield ([#3752](https://github.com/leonardodasneves-eaton/spectrum-web-components/issues/3752)) ([593005a](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/593005a8892139beb9ece9342b51a2b43d63cef3))
-   **textfield:** update spectrum css input ([2ce4ba2](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/2ce4ba2e0a9c6dcc6c0041fde02b0d98f08cf6a1))
-   **textfield:** use Spectrum CSS ^3.0.0 ([1c1acb9](https://github.com/leonardodasneves-eaton/spectrum-web-components/commit/1c1acb94577f97c189a5f4e2d34bf81dc169447c))
